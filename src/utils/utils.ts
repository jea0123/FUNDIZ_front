 ...
 * @returns 해당 날짜의 23:59:59 시각을 나타내는 Date 객체
 * @example
 ...
 * @param date 날짜 문자열 또는 Date 객체
 * @return 남은 일수를 나타내는 문자열 (예: "5"), 이미 지난 날짜인 경우 "0", 잘못된 날짜 포맷인 경우 "-"
 * @example
 ...
 * @param date 날짜 문자열 또는 Date 객체
 * @returns 남은 시간을 나타내는 문자열 (예: "1일", "2주", "1시간", "1분", "방금", "-")
 * @example
