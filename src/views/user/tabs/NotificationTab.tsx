...
import { Bell, CheckCircle2, Loader2, Trash2, X } from "lucide-react";
...
import { useNotificationStore, useUnreadCount, } from "@/store/NotificationStore.store"; // ✅ 공유 스토어 사용
...
export default function NotificationTab() {
    ...
    const deleteAll = async () => {
        const res = await deleteData(
            endpoints.deleteAllNotifications,
            cookie.accessToken
        );
        if (res?.status === 200) {
            clear();
