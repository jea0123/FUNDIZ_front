            ...
            <DialogContent>
              ...
              <div className="space-y-3">
                <input
                  ...
                  onChange={(e) => setAddrAdd({ ...addrAdd, addrName: e.target.value })}
                />
                <input
                  type="text"
                  placeholder="받는 사람"
                  ...
                  onChange={(e) => setAddrAdd({ ...addrAdd, recipient: e.target.value })}
                />
                <input
                  type="text"
                  placeholder="연락처"
                ...
                <input
                  ...
                  onChange={(e) => setAddrAdd({ ...addrAdd, postalCode: e.target.value })}
                />
                <input
                  type="text"
                  placeholder="도로명 주소"
                  ...
                  onChange={(e) => setAddrAdd({ ...addrAdd, roadAddr: e.target.value })}
                />
                <input
                  type="text"
                  placeholder="상세 주소"
                  ...
                  onChange={(e) => setAddrAdd({ ...addrAdd, detailAddr: e.target.value })}
                />
              </div>
